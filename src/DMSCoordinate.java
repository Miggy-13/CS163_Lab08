public class DMSCoordinate {
    ...
    public DMSCoordinate(int degreesLat, int minutesLat, int secondsLat, int degreesLong, int minutesLong,
            int secondsLong) {
    ...
    public void setLatitude(String latitude) {
        ...
        if (((parsedDegrees <= 60) && (parsedDegrees >= 0)) && ((parsedMinutes <= 60) && (parsedMinutes >= 0))
