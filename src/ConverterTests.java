public class ConverterTests {
    ...
    public static boolean testDMSCoordConstruction1() {
        ...
        if (testDMS.getDegreesLat() == 39)
            test1 = true;
        if (testDMS.getSecondsLong() == 22)
            test2 = true;
    ...
    public static boolean testDecimalCoordConstruction1() {
        ...
        if (testDecimal.getLatitude() == 38.6541)
            test1 = true;
        if (testDecimal.getLongitude() == 59.0009)
            test2 = true;
    ...
    public static boolean testDecimalCoordConstruction2() {
        ...
        if (testDecimal.getLatitude() == 0)
            test1 = true;
        if (testDecimal.getLongitude() == 0)
            test2 = true;
    ...
    public static boolean testDMSConverter() {
        ...
        if (testDecimal.toString().equals("39.8867 25.9569"))
            return true;
        else
            return false;
    }
    ...
    public static boolean testDecimalConverter() {
        ...
        if (testDMS.getLatitude().equals("38°59'8\""))
            test1 = true;
        if (testDMS.getLongitude().equals("25°55'23\""))
            test2 = true;
        return test1 && test2;
    }
    ...
    public static void main(String[] args) {
        ...
        // System.out.println("Testing DMSCoordinate construction (In Bounds): " +
        // testDMSCoordConstruction1() + ", should return true when method is
        // implemented.");
        // System.out.println("Testing DMSCoordinate construction (Out of Bounds): " +
        // testDMSCoordConstruction2() + ", should return true when method is
        // implemented.");

        // System.out.println();
        // System.out.println("Testing DecimalCoordinate construction (In Bounds): " +
        // testDecimalCoordConstruction1()
        // + ", should return true when method is implemented.");
        // System.out.println("Testing DecimalCoordinate construction (Out of Bounds): "
        // + testDecimalCoordConstruction2()
        // + ", should return true when method is implemented.");

        // System.out.println();
        System.out.println("Testing DMSConverter conversion: " + testDMSConverter()
                + ", should return true when method is implemented.");
        // System.out.println("Testing DecimalConverter conversion: " +
        // testDecimalConverter() + ", should return true when method is implemented.");
    }
}
